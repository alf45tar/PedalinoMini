...
void drawFrame2(OLEDDisplay *display, OLEDDisplayUiState* state, int16_t x, int16_t y)
{
  display->setTextAlignment(TEXT_ALIGN_CENTER);
  display->setFont(ArialMT_Plain_16);
  display->drawString(64 + x, 18 + y, host);
  display->drawString(64 + x, 38 + y, WiFi.localIP().toString());
}
...
void drawFrame3(OLEDDisplay *display, OLEDDisplayUiState* state, int16_t x, int16_t y)
{
  display->setFont(ArialMT_Plain_10);
  display->setTextAlignment(TEXT_ALIGN_LEFT);
  display->drawString(0 + x, 20 + y, "Device:");
  display->setTextAlignment(TEXT_ALIGN_RIGHT);
  display->drawString(128 + x, 20 + y, host);
  display->setTextAlignment(TEXT_ALIGN_LEFT);
  display->drawString(0 + x, 30 + y, "SSID:");
  display->setTextAlignment(TEXT_ALIGN_RIGHT);
  display->drawString(128 + x, 30 + y, wifiSSID);
  display->setTextAlignment(TEXT_ALIGN_LEFT);
  display->drawString(0 + x, 40 + y, "IP:");
  display->setTextAlignment(TEXT_ALIGN_RIGHT);
  display->drawString(128 + x, 40 + y, WiFi.localIP().toString());
}
